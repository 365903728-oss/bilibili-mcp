...
- Release boundary: npm `1.10.0` and local/remote tag `v1.10.0` are available. The verifier reports no blocker if `docs/agent-memory/pending-learning-proposals.md` remains unstaged.
