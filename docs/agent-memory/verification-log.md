...
- Caveat: Claude Desktop, Cursor, and Codex CLI were not tested because official SDK stdio plus live browser acceptance are the Issue #17 gates. No commit, push, version, changelog, tag, release, or publication occurred. Issue #17 remains open with `ready-for-human` pending explicit Git authorization.
